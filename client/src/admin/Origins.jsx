...
export default function Origins() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      toast.success(editId ? "Origin updated!" : "Origin added!");
      setName("");
      setEditId(null);
      fetchItems();
    } catch (err) {
    ...
    <div className="admin-page template-page-container">
      <div className="admin-top">
        <div style={{ display: 'flex', alignItems: 'center' }}>
          ...
          <h2 className="admin-title" style={{ margin: 0 }}>Manage Origins</h2>
        </div>
      </div>
      ...
      <div className="template-layout">
        ...
        <div className="template-form-section">
          <div className="card">
            <h3 className="card-title">{editId ? "Edit Origin" : "Add New Origin"}</h3>
            ...
            <div className="actions">
              ...
              <button className="btn-primary" onClick={handleSave}>
                {editId ? "Update Origin" : "Add Origin"}
              </button>
            </div>
          </div>
        </div>
        ...
        <div className="template-list-section">
          <div className="card">
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "20px" }}>
              <h3 className="card-title">Existing Origins</h3>
              <input
                type="text"
                placeholder="🔍 Search..."
                value={searchQuery}
            ...
            {loading ? (
              ...
              <div className="template-list">
                {items.length === 0 && <p className="muted">No origins found.</p>}
